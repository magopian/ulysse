...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Evaluation', fields ['jury_member', 'candidate', 'competition_step']
        db.create_unique('competitions_evaluation', ['jury_member_id', 'candidate_id', 'competition_step_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Evaluation', fields ['jury_member', 'candidate', 'competition_step']
        db.delete_unique('competitions_evaluation', ['jury_member_id', 'candidate_id', 'competition_step_id'])
    ...
    models = {
        ...
        'competitions.evaluation': {
            ...
            'notes': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['competitions.EvaluationNote']", 'null': 'True', 'blank': 'True'}),
