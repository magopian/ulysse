...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'EvaluationStatus.slug'
        raise RuntimeError("Cannot reverse this migration. 'EvaluationStatus.slug' and its values cannot be restored.")
