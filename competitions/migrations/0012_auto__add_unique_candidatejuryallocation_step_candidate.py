...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'CandidateJuryAllocation', fields ['step', 'candidate']
        db.create_unique('competitions_candidatejuryallocation', ['step_id', 'candidate_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CandidateJuryAllocation', fields ['step', 'candidate']
        db.delete_unique('competitions_candidatejuryallocation', ['step_id', 'candidate_id'])
    ...
    models = {
        ...
        'competitions.candidatejuryallocation': {
            'Meta': {'unique_together': "(('candidate', 'step'),)", 'object_name': 'CandidateJuryAllocation'},
            'candidate': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['competitions.Candidate']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
