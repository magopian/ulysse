...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EvaluationStatus'
        db.create_table('competitions_evaluationstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('slug', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('competitions', ['EvaluationStatus'])

        # Adding field 'Evaluation.status'
        db.add_column('competitions_evaluation', 'status', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['competitions.EvaluationStatus']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'EvaluationStatus'
        db.delete_table('competitions_evaluationstatus')

        # Deleting field 'Evaluation.status'
        db.delete_column('competitions_evaluation', 'status_id')
