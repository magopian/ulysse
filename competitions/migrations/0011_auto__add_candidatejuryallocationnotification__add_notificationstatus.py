...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CandidateJuryAllocationNotification'
        db.create_table('competitions_candidatejuryallocationnotification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('allocation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['competitions.CandidateJuryAllocation'])),
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['competitions.NotificationStatus'])),
        ))
        db.send_create_signal('competitions', ['CandidateJuryAllocationNotification'])

        # Adding model 'NotificationStatus'
        db.create_table('competitions_notificationstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length='50')),
        ))
        db.send_create_signal('competitions', ['NotificationStatus'])


    def backwards(self, orm):
        
        # Deleting model 'CandidateJuryAllocationNotification'
        db.delete_table('competitions_candidatejuryallocationnotification')

        # Deleting model 'NotificationStatus'
        db.delete_table('competitions_notificationstatus')
    ...
    models = {
        ...
        'competitions.candidatejuryallocationnotification': {
            'Meta': {'object_name': 'CandidateJuryAllocationNotification'},
            'allocation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['competitions.CandidateJuryAllocation']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['competitions.NotificationStatus']"})
        },
        ...
        'competitions.evaluationnote': {
            ...
            'evaluation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['competitions.Evaluation']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        'competitions.notificationstatus': {
            'Meta': {'object_name': 'NotificationStatus'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': "'50'"})
        },
        'composers.composer': {
