...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EvaluationStatus.url'
        db.add_column('competitions_evaluationstatus', 'url', self.gf('django.db.models.fields.CharField')(default=0, max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EvaluationStatus.url'
        db.delete_column('competitions_evaluationstatus', 'url')
