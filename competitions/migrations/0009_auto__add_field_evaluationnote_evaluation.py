...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EvaluationNote.evaluation'
        db.add_column('competitions_evaluationnote', 'evaluation', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['competitions.Evaluation']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EvaluationNote.evaluation'
        db.delete_column('competitions_evaluationnote', 'evaluation_id')
