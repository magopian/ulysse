...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EvaluationNote.name'
        db.add_column('competitions_evaluationnote', 'name', self.gf('django.db.models.fields.CharField')(default=0, max_length=50), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EvaluationNote.name'
        db.delete_column('competitions_evaluationnote', 'name')
