...
class CandidateResidence(competitions.models.Candidate):
...
class EvaluationResidenceJury(competitions.models.Evaluation):
...
class EvaluationResidencePostJury(competitions.models.Evaluation):    
