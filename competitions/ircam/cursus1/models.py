...
class CandidateCursus1(competitions.models.Candidate):
...
class EvaluationCursus1PreJury(competitions.models.Evaluation):
...
class EvaluationCursus1Jury(competitions.models.Evaluation):    
    note     = models.IntegerField(verbose_name="note",help_text="note de 1 à 10 (facultative)")    
    comments = models.TextField(verbose_name="commentaires")
