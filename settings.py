# Django settings for ulysse project.
...
STATIC_ROOT = '/home/topic/www/ulysse/public/static'
...
SECRET_KEY = '#*pf#u-r@qfpmzvh_qm4dk@c_25-k2bwuakva^30)xs^1c@_-='
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '/home/topic/www/ulysse/templates'
)
